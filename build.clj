(ns build
  "tools.build declarations for the clerk-templates library."
  (:require [clojure.tools.build.api :as b]))

;; ## Variables

(def lib 'nextjournal/clerk-template)
(def version "0.1.0")
...
(defn jar
  ...
  (let [version  (->version version-suffix)
    ...
    (b/write-pom {:class-dir class-dir
                  ...
                  :scm
                  {:tag (str "v" version)
                   :connection "scm:git:git://github.com/nextjournal/clerk-cljs-demo.git"
                   :developConnection "scm:git:ssh://git@github.com/nextjournal/clerk-cljs-demo.git"
                   :url "https://github.com/nextjournal/clerk-cljs-demo"}
                  :basis basis
